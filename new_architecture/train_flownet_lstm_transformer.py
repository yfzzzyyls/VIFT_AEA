...
Supports variable-length sequences and all IMU data.

Usage:
    # Single GPU training
    python train_flownet_lstm_transformer.py --use-amp --variable-length --load-raw-imu
    
    # Multi-GPU training with DDP
    torchrun --nproc_per_node=4 train_flownet_lstm_transformer.py \
        --distributed --use-amp --variable-length --load-raw-imu
"""
